...
export function meta({}: Route.MetaArgs) {
    return [
        { title: "Musica Ignota" },
        { name: "description", content: "Language player" },
    ];
}

const MODES: PlayerData[] = [
    { key: "major", label: "Major", list: [1, 3, 5, 8, 10], initial: true },
    { key: "suspended", label: "Suspended", list: [1, 3, 6, 8, 11], initial: false },
    { key: "blues major", label: "Blues major", list: [1, 4, 6, 9, 11], initial: false },
    { key: "blues minor", label: "Blues minor", list: [1, 3, 6, 8, 10], initial: false },
    { key: "minor", label: "Minor", list: [1, 4, 6, 8, 11], initial: false },
];

const NOTES: PlayerData[] = [
    { key: "0", label: "C", value: 16.351, initial: true },
    { key: "1", label: "C♯/D♭", value: 17.324, initial: false },
    { key: "2", label: "D", value: 18.354, initial: false },
    { key: "3", label: "D♯/E♭", value: 19.445, initial: false },
    { key: "4", label: "E", value: 20.601, initial: false},
    { key: "5", label: "F", value: 21.827, initial: false },
    { key: "6", label: "F♯/G♭", value: 23.124, initial: false },
    { key: "7", label: "G", value: 24.499, initial: false },
    { key: "8", label: "G♯/A♭", value: 25.596, initial: false },
    { key: "9", label: "A", value: 27.5, initial: false },
    { key: "10", label: "A♯/B♭", value: 29.135, initial: false },
    { key: "11", label: "B", value: 30.868, initial: false }
];

const OCTAVES: PlayerData[] = [
    { key: "1", label: "1", value: 1, initial: false },
    { key: "2", label: "2", value: 2, initial: false },
    { key: "3", label: "3", value: 3, initial: true },
    { key: "4", label: "4", value: 4, initial: false },
    { key: "5", label: "5", value: 5, initial: false },
    { key: "6", label: "6", value: 6, initial: false }
];
